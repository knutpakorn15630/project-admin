...
export class ApiserviceService {
  ...
  public searchReportDate(body: ReqSearchDate): Observable<ResSearchDate> {
    return this.httpApiClient.post<ResSearchDate>(`${this.apiUrl}/api/report/checkMonth`, body);
  }
  ...
  sumReport(): Observable<ResSum> {
    return this.httpApiClient.get<ResSum>(`${this.apiUrl}/api/report/sumElite`);
  }
